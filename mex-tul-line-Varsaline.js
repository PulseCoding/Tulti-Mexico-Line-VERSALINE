          ...
          //------------------------------------------Filler1----------------------------------------------
                ...
                if (Filler1flagPrint == 1) {
                  for (var key in Filler1results) {
                    ...
                    //NOTE: Cambiar path
                    fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_Filler1_Varsaline.log', 'tt=' + Filler1time + ',var=' + key + ',val=' + Filler1results[key] + '\n')
                  }
                  Filler1flagPrint = 0
                  Filler1secStop = 0
                  Filler1time = Date.now()
          ...
          //------------------------------------------Filler2----------------------------------------------
                ...
                if (Filler2flagPrint == 1) {
                  for (var key in Filler2results) {
                    ...
                    //NOTE: Cambiar path
                    fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_Filler2_Varsaline.log', 'tt=' + Filler2time + ',var=' + key + ',val=' + Filler2results[key] + '\n')
                  }
                  Filler2flagPrint = 0
                  Filler2secStop = 0
                  Filler2time = Date.now()
          ...
          //------------------------------------------StickInserter----------------------------------------------
                ...
                if (StickInserterflagPrint == 1) {
                  for (var key in StickInserterresults) {
                    ...
                    //NOTE: Cambiar path
                    fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_StickInserter_Varsaline.log', 'tt=' + StickInsertertime + ',var=' + key + ',val=' + StickInserterresults[key] + '\n')
                  }
                  StickInserterflagPrint = 0
                  StickInsertersecStop = 0
                  StickInsertertime = Date.now()
              ...
              //------------------------------------------PickAndPlace----------------------------------------------
                    ...
                    if (PickAndPlaceflagPrint == 1) {
                      for (var key in PickAndPlaceresults) {
                        ...
                        //NOTE: Cambiar path
                        fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_PickAndPlace_Varsaline.log', 'tt=' + PickAndPlacetime + ',var=' + key + ',val=' + PickAndPlaceresults[key] + '\n')
                      }
                      PickAndPlaceflagPrint = 0
                      PickAndPlacesecStop = 0
                      PickAndPlacetime = Date.now()
                ...
                //------------------------------------------Wrapping----------------------------------------------
                      ...
                      if (WrappingflagPrint == 1) {
                        for (var key in Wrappingresults) {
                          ...
                          //NOTE: Cambiar path
                          fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_Wrapping_Varsaline.log', 'tt=' + Wrappingtime + ',var=' + key + ',val=' + Wrappingresults[key] + '\n')
                        }
                        WrappingflagPrint = 0
                        WrappingsecStop = 0
                        Wrappingtime = Date.now()
                ...
                client5.readHoldingRegisters(0, 16).then(function(resp) {
                  ...
                  //------------------------------------------CasePacker----------------------------------------------
                        ...
                        if (CasePackerflagPrint == 1) {
                          for (var key in CasePackerresults) {
                            ...
                            //NOTE: Cambiar path
                            fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_CasePacker_Varsaline.log', 'tt=' + CasePackertime + ',var=' + key + ',val=' + CasePackerresults[key] + '\n')
                          }
                          CasePackerflagPrint = 0
                          CasePackersecStop = 0
                          CasePackertime = Date.now()
                  ...
                  //------------------------------------------CaseSealer----------------------------------------------
                        ...
                        if (CaseSealerflagPrint == 1) {
                          for (var key in CaseSealerresults) {
                            ...
                            //NOTE: Cambiar path
                            fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_CaseSealer_Varsaline.log', 'tt=' + CaseSealertime + ',var=' + key + ',val=' + CaseSealerresults[key] + '\n')
                          }
                          CaseSealerflagPrint = 0
                          CaseSealersecStop = 0
                          CaseSealertime = Date.now()
                  ...
                  //------------------------------------------BoxFormer----------------------------------------------
                        ...
                        if (BoxFormerflagPrint == 1) {
                          for (var key in BoxFormerresults) {
                            ...
                            //NOTE: Cambiar path
                            fs.appendFileSync('C:/Pulse/VERSALINE_LOGS/mex_tul_BoxFormer_Varsaline.log', 'tt=' + BoxFormertime + ',var=' + key + ',val=' + BoxFormerresults[key] + '\n')
                          }
                          BoxFormerflagPrint = 0
                          BoxFormersecStop = 0
                          BoxFormertime = Date.now()
                  ...
                  /*----------------------------------------------------------------------------------EOL----------------------------------------------------------------------------------*/
                       if(secEOL>=60 && CntOutEOL){
                          fs.appendFileSync("C:/Pulse/VERSALINE_LOGS/mex_tul_eol_Varsaline.log","tt="+Date.now()+",var=EOL"+",val="+CntOutEOL+"\n");
                          secEOL=0;
                        }else{
                          secEOL++;
                        }
